...
public class LikedTweetsState implements Cloneable {
    @Nullable
    ...
    public void setTwitterException(@Nullable TwitterException exception) {
        this.twitterException = exception;
    }

    @Override
    public LikedTweetsState clone() {
        LikedTweetsState object = null;
        try {
            object = (LikedTweetsState) super.clone();
